...
export const Dashboard = () => {
  ...
  const fetchBuyerStats = async () => {
    try {
      // Fetch all buyer's orders to calculate stats
        ...
        return (
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <Card className="text-center">
                <h3 className="text-4xl font-bold text-primary-600">৳{buyerStats.totalSpent.toFixed(2)}</h3>
                <p className="text-gray-600 mt-2">Total Spent</p>
              </Card>
              <Card className="text-center">
                <h3 className="text-4xl font-bold text-primary-600">{buyerStats.pendingOrders}</h3>
